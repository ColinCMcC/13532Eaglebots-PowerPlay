...
public class IMUDrive extends LinearOpMode {
    ...
    public void runOpMode() {
        front_left_wheel = hardwareMap.dcMotor.get("FLMotor");
        back_left_wheel = hardwareMap.dcMotor.get("BLMotor");
        back_right_wheel = hardwareMap.dcMotor.get("BRMotor");
        front_right_wheel = hardwareMap.dcMotor.get("FRMotor");
    ...
    public void drive() {
        ...
        front_left_wheel.setPower(Py - rotate);
        back_left_wheel.setPower(Px - rotate);
        back_right_wheel.setPower(Py + rotate);
        front_right_wheel.setPower(Px + rotate);
    }
